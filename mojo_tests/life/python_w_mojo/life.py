"""Python Game of Life with Mojo-accelerated Grid"""
import time
...
def run_display(
    ...
    pygame.display.set_caption("Conway's Game of Life (Python + Mojo)")
    ...
    while running:
        ...
        # Next generation (using Mojo-accelerated evolve)
        grid = grid.evolve()
